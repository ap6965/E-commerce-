    ...
    <head>
        ...
        <script>
            function likeStatus(statusid)
            {
                ...
                obj.open("GET", "LikeStatus?statusid="+statusid, true);
                obj.send();
                        ...
                        <div class="shadow p-4 mb-5 bg-body rounded">
                            ...
                            <div class="status_heading">
                                <%
                                    ...
                                    time1 = time1.replace(":","");
                                %>
                                <i class="bi bi-hand-thumbs-up" id="likebutton<%=count%>" onclick="likeStatus(<%=statusid%>)"></i>  <span id="resgenerated<%=statusid%>"></span>
                            </div>
                        </div>
