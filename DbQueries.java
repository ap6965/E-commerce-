...
public class DbQueries 
{
    ...
    public static boolean uploadStatus(String email, String status_text, String status_img, String date1, String time1)
    {
        ...
        try
        {
            ...
            PreparedStatement ps = con.prepareStatement("insert into status(email, status_text, status_image, date1, time1) value(?,?,?,?,?)");
            ps.setString(1, email);
    ...
    public static boolean likeStatus(String statusid , String email)
    {
        boolean status = false;
        try
        {
